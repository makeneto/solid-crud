        ...
        >
          ...
          <div className="cart__items--item--content">
            <div className="cart__items--item--content--primary">
              <h2 className="cart__items--item--content--primary--title">
                {title}
              </h2>
              <p className="cart__items--item--content--primary--description small__text">
                {description}
              </p>
              <p className="cart__items--item--content--primary--publisher">
                {publisher}
              </p>
            ...
            <div className="cart__items--gears">
              <button type="button" className="cart__items--item--remove">
              ...
              <div className="cart__items--item--price">
                ...
                <span className="cart__items--item--price--old">
                  {oldPrice}
                </span>
              </div>
            </div>
